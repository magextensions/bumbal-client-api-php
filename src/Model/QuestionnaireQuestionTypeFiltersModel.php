...
/**
 * QuestionnaireQuestionTypeFiltersModel Class Doc Comment
 *
 * @category    Class
 * @package     BumbalClient
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class QuestionnaireQuestionTypeFiltersModel implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'QuestionnaireQuestionTypeFiltersModel';
    ...
    /**
     * Sets id
     * @param int[] $id QuestionnaireQuestionType id's
     * @return $this
     */
    ...
    /**
     * Sets name
     * @param string[] $name QuestionnaireQuestionType names
     * @return $this
     */
