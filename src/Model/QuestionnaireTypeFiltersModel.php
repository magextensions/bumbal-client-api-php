...
/**
 * QuestionnaireTypeFiltersModel Class Doc Comment
 *
 * @category    Class
 * @package     BumbalClient
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class QuestionnaireTypeFiltersModel implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'QuestionnaireTypeFiltersModel';
    ...
    /**
     * Sets id
     * @param int[] $id QuestionnaireType id's
     * @return $this
     */
    ...
    /**
     * Sets name
     * @param string[] $name QuestionnaireType names
     * @return $this
     */
