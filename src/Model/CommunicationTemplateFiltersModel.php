<?php
/**
 * CommunicationTemplateFiltersModel
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * CommunicationTemplateFiltersModel Class Doc Comment
 *
 * @category    Class
 * @package     BumbalClient
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class CommunicationTemplateFiltersModel implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CommunicationTemplateFiltersModel';
    ...
    /**
     * Sets id
     * @param int[] $id Bumbal communication template id's
     * @return $this
     */
    ...
    /**
     * Sets name
     * @param string[] $name template names
     * @return $this
     */
